...
import { createPengolahanBerasCampuran } from "../../redux/modal/ModalAction";

const ModalTambahModalKelolaCampuran = (props) => {
  const { campuran, berat, idBerasKelola, handleClose2nd } = props;
...
export default ModalTambahModalKelolaCampuran;
